...
const supabaseUrl = (window as any).SUPABASE_CONFIG?.url || 'https://atvwnghqynoturvhoulb.supabase.co';
const supabaseAnonKey = (window as any).SUPABASE_CONFIG?.anonKey || 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImF0dnduZ2hxeW5vdHVydmhvdWxiIiwicm9sZSI6ImFub24iLCJpYXQiOjE3NTg1Njg1NjIsImV4cCI6MjA3NDE0NDU2Mn0.eCAd-i4UpPkLHIH77ST0-Zt0_Zcxp0SCox9VAOTPt0A';
